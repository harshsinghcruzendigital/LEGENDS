...
<div class="page">
  <div class="page-content">
    ...
    <div class="grid-3">
      ...
      <div class="card-stat">
        <div class="stat-number" style="color: #10b981;">Scanner Active</div>
        <div class="stat-label">Real Live HTTP/SSL/RDAP</div>
      </div>
      <div class="card-stat">
        <div class="stat-number" style="color: #10b981;">Discovery Live</div>
        <div class="stat-label">Live Web Ingestion & Audits</div>
      </div>
    </div>

    <h1>1. Is the Website Fetching Live Data? (Verified Status)</h1>
    ...
    <div class="highlight-box success">
      <div class="highlight-title">YES — The Lead Discovery Engine (/discovery) Fetches 100% Real Live Data</div>
      The Discovery module connects to live web business search engines and industry directories to discover real companies in real time. It passes every discovered domain through the live <code>auditWebsite</code> engine (SSL, TTFB, SEO, security headers, contacts) and persists authentic leads to PostgreSQL.
    </div>
